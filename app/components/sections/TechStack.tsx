        ...
        <ScrollAnimation>
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 bg-primary/5 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-primary font-semibold text-sm">Technologies We Use</span>
            </div>
          ...
          <div className="marquee">
            <div className="marquee-track marquee-track-left gap-6 md:gap-10">
              {duplicatedTech.map((tech, index) => (
                <div
                  key={`right-${index}`}
                  className="flex-shrink-0 min-w-[100px] min-h-[100px] md:min-w-[100px] md:min-h-[100px] bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 flex items-center justify-center p-5"
