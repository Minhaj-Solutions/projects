      ...
      <div className="section-shell">
        ...
        <ScrollAnimation>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl max-[375px]:text-3xl md:text-5xl font-bold text-gray-900 mb-4">
              Our Services
            </h2>
            <p className="text-lg max-[375px]:text-base text-gray-600 max-w-2xl mx-auto">
              Comprehensive solutions across four key categories to transform
              your business
            </p>
          </div>
        </ScrollAnimation>
                ...
                <Link href={`/services/${service.slug}`}>
                  <div className="group relative h-80 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      ...
                      <h3 className="text-2xl max-[375px]:text-xl font-bold text-white mb-3">
                        {service.title}
                      </h3>
