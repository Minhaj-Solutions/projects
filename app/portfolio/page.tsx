...
import { caseStudies, getAllCategories, getFeaturedCaseStudies } from '@/data/case-studies'
          ...
          <ScrollAnimation>
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                ...
                technologies. Each case study showcases our expertise and the results we deliver
                for our clients.
              </p>
            </div>
          </ScrollAnimation>
